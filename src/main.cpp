...
const string strMessageMagic = "LakrassCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LakrassCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Lakrass team ";
        CTransaction txNew;
        txNew.nTime = 1520907135;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1520907135;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1804304 : 1804304;
        ...
        assert(block.hashMerkleRoot == uint256("0x2d4f44cf63e61e29ad5de4b987a5dc3b6bc6f0a9f163fc67d89d548eaae18c97"));
...
unsigned char pchMessageStart[4] = { 0xe3, 0xdf, 0x05, 0xf6 };
