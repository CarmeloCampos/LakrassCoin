...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 LKR"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 LKR"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 LKR"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 LKR"));
