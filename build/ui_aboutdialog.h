...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About LakrassCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>LakrassCoin</b> version", 0));
...
"Copyright \302\251 2018 The LakrassCoin developers", 0));
